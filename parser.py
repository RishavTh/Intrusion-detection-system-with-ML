...
NEPAL_RANGES = [
    ...
    ('27.34.0.0',     '27.34.255.255'),      # Vianet Nepal
    ('27.111.0.0',    '27.111.255.255'),     # Vianet Nepal range 2
    ('103.146.96.0',  '103.146.127.255'),    # Classic Tech Nepal
    ('103.144.224.0', '103.144.255.255'),    # Classic Tech Nepal range 2
    ('103.99.0.0',    '103.99.3.255'),       # Nepal ISP
    ('124.41.0.0',    '124.41.255.255'),     # Nepal Telecom
    ('36.252.0.0',    '36.252.255.255'),     # Dish Home Nepal
    ('49.47.0.0',     '49.47.255.255'),      # Nepal ISP
    ('8.8.8.0',       '8.8.8.255'),          # Google DNS — whitelist
]
